...
// include: C:\Users\fifty\AppData\Local\Temp\tmp3_xmx43r.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'C:/Users/fifty/Documents/Github/SP20ChemSim/sp4.data';
      var REMOTE_PACKAGE_BASE = 'sp4.data';
...
Module['FS_createPath']("/", "textures", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_C:/Users/fifty/Documents/Github/SP20ChemSim/sp4.data');
      }
      Module['addRunDependency']('datafile_C:/Users/fifty/Documents/Github/SP20ChemSim/sp4.data');
    ...
    loadPackage({"files": [{"filename": "/data/bowserinator-PeriodicTableJSON.json", "start": 0, "end": 281004}, {"filename": "/data/cie-1964-colorimetric-observer-chart.txt", "start": 281004, "end": 285296}, {"filename": "/data/exabyte-periodic-table.json", "start": 285296, "end": 381140}, {"filename": "/data/nist-asd-wv.txt", "start": 381140, "end": 381457}, {"filename": "/data/periodic-table-lookup.json", "start": 381457, "end": 647555}, {"filename": "/fonts/Atkinson-Hyperlegible-Regular-102.ttf", "start": 647555, "end": 690151}, {"filename": "/fonts/Atkinson-Hyperlegible-SIL-OPEN-FONT-LICENSE-Version 1.1-v2 ACC.pdf", "start": 690151, "end": 753788}, {"filename": "/sfx/DING.wav", "start": 753788, "end": 853146}, {"filename": "/sfx/bing.wav", "start": 853146, "end": 870728}, {"filename": "/sfx/bump1.wav", "start": 870728, "end": 880284}, {"filename": "/sfx/bump2.wav", "start": 880284, "end": 881450}, {"filename": "/sfx/click1.wav", "start": 881450, "end": 885665}, {"filename": "/sfx/click2.wav", "start": 885665, "end": 898243}, {"filename": "/sfx/click3.wav", "start": 898243, "end": 898539}, {"filename": "/sfx/click4.wav", "start": 898539, "end": 898835}, {"filename": "/sfx/d.wav", "start": 898835, "end": 902515}, {"filename": "/sfx/splash1.wav", "start": 902515, "end": 1212567}, {"filename": "/sfx/suck.wav", "start": 1212567, "end": 1268843}, {"filename": "/textures/arrow_left.png", "start": 1268843, "end": 1271852}, {"filename": "/textures/arrow_right.png", "start": 1271852, "end": 1274846}, {"filename": "/textures/info.png", "start": 1274846, "end": 1298034}, {"filename": "/textures/pause.png", "start": 1298034, "end": 1309240}, {"filename": "/textures/play.png", "start": 1309240, "end": 1321615}], "remote_package_size": 1321615});

  })();

// end include: C:\Users\fifty\AppData\Local\Temp\tmp3_xmx43r.js
// include: C:\Users\fifty\AppData\Local\Temp\tmp9koec7ns.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\fifty\AppData\Local\Temp\tmp9koec7ns.js
// include: C:\Users\fifty\AppData\Local\Temp\tmpcm0leiju.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\fifty\AppData\Local\Temp\tmpcm0leiju.js
...
var ASM_CONSTS = {
  119012: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 121190: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, window.miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 121494: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 121598: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 121769: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 124646: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 124719: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 125119: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 125169: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 125308: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 125448: () => { if (document.fullscreenElement) return 1; },  
 125494: () => { return Module.canvas.width; },  
 125526: () => { return parseInt(Module.canvas.style.width); },  
 125574: () => { document.exitFullscreen(); },  
 125601: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 125673: () => { if (document.fullscreenElement) return 1; },  
 125719: () => { return Module.canvas.width; },  
 125751: () => { return screen.width; },  
 125776: () => { document.exitFullscreen(); },  
 125803: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 125997: () => { return window.innerWidth; },  
 126023: () => { return window.innerHeight; },  
 126050: () => { if (document.fullscreenElement) return 1; },  
 126096: () => { return Module.canvas.width; },  
 126128: () => { return parseInt(Module.canvas.style.width); },  
 126176: () => { if (document.fullscreenElement) return 1; },  
 126222: () => { return Module.canvas.width; },  
 126254: () => { return screen.width; },  
 126279: () => { return window.innerWidth; },  
 126305: () => { return window.innerHeight; },  
 126332: () => { if (document.fullscreenElement) return 1; },  
 126378: () => { return Module.canvas.width; },  
 126410: () => { return screen.width; },  
 126435: () => { document.exitFullscreen(); },  
 126462: () => { if (document.fullscreenElement) return 1; },  
 126508: () => { return Module.canvas.width; },  
 126540: () => { return parseInt(Module.canvas.style.width); },  
 126588: () => { document.exitFullscreen(); },  
 126615: ($0) => { Module.canvas.style.opacity = $0; },  
 126653: () => { return screen.width; },  
 126678: () => { return screen.height; },  
 126704: () => { return window.screenX; },  
 126731: () => { return window.screenY; },  
 126758: () => { return window.devicePixelRatio; },  
 126794: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 126847: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 126898: () => { Module.canvas.style.cursor = 'none'; },  
 126935: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 127191: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 127242: () => { if (document.pointerLockElement) return 1; },  
 127289: () => { if (document.fullscreenElement) return 1; },  
 127335: () => { return window.innerWidth; },  
 127361: () => { return window.innerHeight; }
};
