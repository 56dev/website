...
// include: C:\Users\fifty\AppData\Local\Temp\tmp2t4tps5_.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'C:/Users/fifty/Documents/Github/SP20ChemSim/sp6.data';
      var REMOTE_PACKAGE_BASE = 'sp6.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_C:/Users/fifty/Documents/Github/SP20ChemSim/sp6.data');
      }
      Module['addRunDependency']('datafile_C:/Users/fifty/Documents/Github/SP20ChemSim/sp6.data');
...
// end include: C:\Users\fifty\AppData\Local\Temp\tmp2t4tps5_.js
// include: C:\Users\fifty\AppData\Local\Temp\tmpv_az_mkf.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\fifty\AppData\Local\Temp\tmpv_az_mkf.js
// include: C:\Users\fifty\AppData\Local\Temp\tmp6njwqlsf.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\fifty\AppData\Local\Temp\tmp6njwqlsf.js
...
var ASM_CONSTS = {
 ...
 142318: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 142391: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 142791: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 142841: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 142980: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 143120: () => { if (document.fullscreenElement) return 1; },  
 143166: () => { return Module.canvas.width; },  
 143198: () => { return parseInt(Module.canvas.style.width); },  
 143246: () => { document.exitFullscreen(); },  
 143273: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 143345: () => { if (document.fullscreenElement) return 1; },  
 143391: () => { return Module.canvas.width; },  
 143423: () => { return screen.width; },  
 143448: () => { document.exitFullscreen(); },  
 143475: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 143669: () => { return window.innerWidth; },  
 143695: () => { return window.innerHeight; },  
 143722: () => { if (document.fullscreenElement) return 1; },  
 143768: () => { return Module.canvas.width; },  
 143800: () => { return parseInt(Module.canvas.style.width); },  
 143848: () => { if (document.fullscreenElement) return 1; },  
 143894: () => { return Module.canvas.width; },  
 143926: () => { return screen.width; },  
 143951: () => { return window.innerWidth; },  
 143977: () => { return window.innerHeight; },  
 144004: () => { if (document.fullscreenElement) return 1; },  
 144050: () => { return Module.canvas.width; },  
 144082: () => { return screen.width; },  
 144107: () => { document.exitFullscreen(); },  
 144134: () => { if (document.fullscreenElement) return 1; },  
 144180: () => { return Module.canvas.width; },  
 144212: () => { return parseInt(Module.canvas.style.width); },  
 144260: () => { document.exitFullscreen(); },  
 144287: ($0) => { Module.canvas.style.opacity = $0; },  
 144325: () => { return screen.width; },  
 144350: () => { return screen.height; },  
 144376: () => { return window.screenX; },  
 144403: () => { return window.screenY; },  
 144430: () => { return window.devicePixelRatio; },  
 144466: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 144519: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 144570: () => { Module.canvas.style.cursor = 'none'; },  
 ...
 144863: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 144914: () => { if (document.pointerLockElement) return 1; },  
 144961: () => { if (document.fullscreenElement) return 1; },  
 145007: () => { return window.innerWidth; },  
 145033: () => { return window.innerHeight; }
};
