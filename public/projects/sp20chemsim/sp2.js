...
// include: C:\Users\fifty\AppData\Local\Temp\tmp37s9or7n.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'C:/Users/fifty/Documents/Github/SP20ChemSim/sp2.data';
      var REMOTE_PACKAGE_BASE = 'sp2.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_C:/Users/fifty/Documents/Github/SP20ChemSim/sp2.data');
      }
      Module['addRunDependency']('datafile_C:/Users/fifty/Documents/Github/SP20ChemSim/sp2.data');
...
// end include: C:\Users\fifty\AppData\Local\Temp\tmp37s9or7n.js
// include: C:\Users\fifty\AppData\Local\Temp\tmpgxdhggjh.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\fifty\AppData\Local\Temp\tmpgxdhggjh.js
// include: C:\Users\fifty\AppData\Local\Temp\tmpqtuzafr4.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\fifty\AppData\Local\Temp\tmpqtuzafr4.js
...
var ASM_CONSTS = {
 ...
 128390: () => { document.exitFullscreen(); },  
 128417: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 128489: () => { if (document.fullscreenElement) return 1; },  
 128535: () => { return Module.canvas.width; },  
 128567: () => { return screen.width; },  
 128592: () => { document.exitFullscreen(); },  
 128619: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 128813: () => { return window.innerWidth; },  
 128839: () => { return window.innerHeight; },  
 128866: () => { if (document.fullscreenElement) return 1; },  
 128912: () => { return Module.canvas.width; },  
 128944: () => { return parseInt(Module.canvas.style.width); },  
 128992: () => { if (document.fullscreenElement) return 1; },  
 129038: () => { return Module.canvas.width; },  
 129070: () => { return screen.width; },  
 129095: () => { return window.innerWidth; },  
 129121: () => { return window.innerHeight; },  
 129148: () => { if (document.fullscreenElement) return 1; },  
 129194: () => { return Module.canvas.width; },  
 129226: () => { return screen.width; },  
 129251: () => { document.exitFullscreen(); },  
 129278: () => { if (document.fullscreenElement) return 1; },  
 129324: () => { return Module.canvas.width; },  
 129356: () => { return parseInt(Module.canvas.style.width); },  
 129404: () => { document.exitFullscreen(); },  
 129431: ($0) => { Module.canvas.style.opacity = $0; },  
 129469: () => { return screen.width; },  
 129494: () => { return screen.height; },  
 129520: () => { return window.screenX; },  
 129547: () => { return window.screenY; },  
 129574: () => { return window.devicePixelRatio; },  
 129610: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 129663: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 129714: () => { Module.canvas.style.cursor = 'none'; },  
 129751: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 130007: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 130058: () => { if (document.pointerLockElement) return 1; },  
 130105: () => { if (document.fullscreenElement) return 1; },  
 130151: () => { return window.innerWidth; },  
